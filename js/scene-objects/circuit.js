...
export class Circuit {
    ...
    prodPinLocWrl(pinIndex) {
        return new Vec2(this.rectWrl.x + this.rectWrl.w, this.rectWrl.y + pinIndex * Circuit.pinToPinDist);
    }
    prodPinLocScr(pinIndex) {
        const rect = this.screenRect();
        return new Vec2(rect.x + rect.w, rect.y + pinIndex * Circuit.pinToPinDist * viewManager.zoomLevel);
    }
    conPinLocScr(pinIndex) {
